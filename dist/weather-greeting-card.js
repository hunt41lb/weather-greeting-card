...
const WEATHER_ICONS = {
  // Clear conditions
  "clear-day": `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64">
    <defs>
      <linearGradient id="sun-grad" x1="16.5" y1="19.67" x2="21.5" y2="28.33" gradientUnits="userSpaceOnUse">
    ...
    <g>
      <circle cx="32" cy="32" r="11" fill="url(#sun-grad)" stroke="#f8af18" stroke-miterlimit="10" stroke-width=".5"/>
      <path fill="none" stroke="#fbbf24" stroke-linecap="round" stroke-miterlimit="10" stroke-width="2" d="M32 15.71V9.5m0 45v-6.21m11.52-27.81l4.39-4.39M16.09 47.91l4.39-4.39m0-23.04l-4.39-4.39m31.82 31.82l-4.39-4.39M15.71 32H9.5m45 0h-6.21">
        <animateTransform attributeName="transform" dur="45s" from="0 32 32" repeatCount="indefinite" to="360 32 32" type="rotate"/>
      </path>
    </g>
  </svg>`,

  "clear-night": `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64">
    <defs>
      <linearGradient id="moon-grad" x1="21.92" y1="18.75" x2="38.52" y2="47.52" gradientUnits="userSpaceOnUse">
    ...
    <g>
      <path fill="url(#moon-grad)" stroke="#72b9d5" stroke-linecap="round" stroke-linejoin="round" stroke-width=".5" d="M46.66 36.2a16.66 16.66 0 01-16.78-16.55 16.29 16.29 0 01.55-4.15A16.56 16.56 0 1048.5 36.1a16.94 16.94 0 01-1.84.1z">
        <animateTransform attributeName="transform" dur="5s" repeatCount="indefinite" type="rotate" values="-5 32 32; 15 32 32; -5 32 32"/>
      </path>
    </g>
  </svg>`,

  // Cloudy conditions
  "cloudy-day": `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64">
    <defs>
      <linearGradient id="cd-sun" x1="13.5" y1="15.67" x2="17" y2="21.5" gradientUnits="userSpaceOnUse">
        <stop offset="0" stop-color="#fbbf24"/>
        <stop offset=".45" stop-color="#fbbf24"/>
        <stop offset="1" stop-color="#f59e0b"/>
      </linearGradient>
      <linearGradient id="cd-cloud" x1="22.56" x2="39.2" y1="21.96" y2="50.8" gradientUnits="userSpaceOnUse">
    ...
    <g>
      <circle cx="19" cy="20" r="5" fill="url(#cd-sun)" stroke="#f8af18" stroke-miterlimit="10" stroke-width=".5"/>
    ...
    <path fill="url(#cd-cloud)" stroke="#e6effc" stroke-miterlimit="10" stroke-width=".5" d="M46.5 31.5h-.32a10.49 10.49 0 00-19.11-8 7 7 0 00-10.57 6 7.21 7.21 0 00.1 1.14A7.5 7.5 0 0018 45.5a4.19 4.19 0 00.5 0v0h28a7 7 0 000-14z">
      <animateTransform attributeName="transform" dur="7s" repeatCount="indefinite" type="translate" values="-3 0; 3 0; -3 0"/>
    </path>
  </svg>`,

  "cloudy-night": `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64">
    <defs>
      <linearGradient id="cn-moon" x1="13.58" y1="15.57" x2="24.15" y2="33.87" gradientUnits="userSpaceOnUse">
        <stop offset="0" stop-color="#86c3db"/>
        <stop offset=".45" stop-color="#86c3db"/>
        <stop offset="1" stop-color="#5eead4"/>
      </linearGradient>
      <linearGradient id="cn-cloud" x1="22.56" x2="39.2" y1="21.96" y2="50.8" gradientUnits="userSpaceOnUse">
        <stop offset="0" stop-color="#f3f7fe"/>
        <stop offset=".45" stop-color="#f3f7fe"/>
        <stop offset="1" stop-color="#deeafb"/>
      </linearGradient>
    ...
    <g>
      <path fill="url(#cn-moon)" stroke="#72b9d5" stroke-linecap="round" stroke-linejoin="round" stroke-width=".5" d="M29.33 26.68a10.61 10.61 0 01-10.68-10.54 10.5 10.5 0 01.34-2.65 10.56 10.56 0 1011.51 13.11 11.75 11.75 0 01-1.17.08z">
        <animateTransform attributeName="transform" dur="5s" repeatCount="indefinite" type="rotate" values="-5 19 20; 15 19 20; -5 19 20"/>
      </path>
    </g>
    <path fill="url(#cn-cloud)" stroke="#e6effc" stroke-miterlimit="10" stroke-width=".5" d="M46.5 31.5h-.32a10.49 10.49 0 00-19.11-8 7 7 0 00-10.57 6 7.21 7.21 0 00.1 1.14A7.5 7.5 0 0018 45.5a4.19 4.19 0 00.5 0v0h28a7 7 0 000-14z">
      <animateTransform attributeName="transform" dur="7s" repeatCount="indefinite" type="translate" values="-3 0; 3 0; -3 0"/>
    </path>
  </svg>`,
  ...
  "cloudy": `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64">
    <defs>
      <linearGradient id="cloudy-grad" x1="22.56" x2="39.2" y1="21.96" y2="50.8" gradientUnits="userSpaceOnUse">
        <stop offset="0" stop-color="#f3f7fe"/>
        <stop offset=".45" stop-color="#f3f7fe"/>
        <stop offset="1" stop-color="#deeafb"/>
      </linearGradient>
    </defs>
    <path fill="url(#cloudy-grad)" stroke="#e6effc" stroke-miterlimit="10" stroke-width=".5" d="M46.5 31.5h-.32a10.49 10.49 0 00-19.11-8 7 7 0 00-10.57 6 7.21 7.21 0 00.1 1.14A7.5 7.5 0 0018 45.5a4.19 4.19 0 00.5 0v0h28a7 7 0 000-14z">
      <animateTransform attributeName="transform" dur="7s" repeatCount="indefinite" type="translate" values="-3 0; 3 0; -3 0"/>
    </path>
  </svg>`,

  // Rainy conditions
  "rainy-day": `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64">
    <defs>
      <linearGradient id="rd-sun" x1="13.5" y1="15.67" x2="17" y2="21.5" gradientUnits="userSpaceOnUse">
        <stop offset="0" stop-color="#fbbf24"/>
        <stop offset=".45" stop-color="#fbbf24"/>
        <stop offset="1" stop-color="#f59e0b"/>
      </linearGradient>
      <linearGradient id="rd-cloud" x1="22.56" x2="39.2" y1="21.96" y2="50.8" gradientUnits="userSpaceOnUse">
        <stop offset="0" stop-color="#f3f7fe"/>
        <stop offset=".45" stop-color="#f3f7fe"/>
        <stop offset="1" stop-color="#deeafb"/>
      </linearGradient>
    ...
    <g>
      <circle cx="19" cy="20" r="5" fill="url(#rd-sun)" stroke="#f8af18" stroke-miterlimit="10" stroke-width=".5"/>
      <path fill="none" stroke="#fbbf24" stroke-linecap="round" stroke-miterlimit="10" stroke-width="2" d="M19 10v-2m0 24v-2m6.93-12.93l1.42-1.42m-18.28 18.28l1.42-1.42m0-14.14l-1.42-1.42m18.28 18.28l-1.42-1.42M10 20H8m22 0h-2">
        <animateTransform attributeName="transform" dur="45s" from="0 19 20" repeatCount="indefinite" to="360 19 20" type="rotate"/>
      </path>
    </g>
    <path fill="url(#rd-cloud)" stroke="#e6effc" stroke-miterlimit="10" stroke-width=".5" d="M46.5 31.5h-.32a10.49 10.49 0 00-19.11-8 7 7 0 00-10.57 6 7.21 7.21 0 00.1 1.14A7.5 7.5 0 0018 45.5a4.19 4.19 0 00.5 0v0h28a7 7 0 000-14z"/>
    <g>
      <path fill="none" stroke="#2885c7" stroke-linecap="round" stroke-miterlimit="10" stroke-width="2" d="M24.08 45.01l-.16.98m4.16-2.99l-.64 3.94m4.16-5.97l-1.12 6.9">
  ...
  "rainy-night": `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64">
    <defs>
      <linearGradient id="rn-moon" x1="13.58" y1="15.57" x2="24.15" y2="33.87" gradientUnits="userSpaceOnUse">
        <stop offset="0" stop-color="#86c3db"/>
        <stop offset=".45" stop-color="#86c3db"/>
        <stop offset="1" stop-color="#5eead4"/>
      </linearGradient>
      <linearGradient id="rn-cloud" x1="22.56" x2="39.2" y1="21.96" y2="50.8" gradientUnits="userSpaceOnUse">
        <stop offset="0" stop-color="#f3f7fe"/>
        <stop offset=".45" stop-color="#f3f7fe"/>
        <stop offset="1" stop-color="#deeafb"/>
      </linearGradient>
    ...
    <g>
      <path fill="url(#rn-moon)" stroke="#72b9d5" stroke-linecap="round" stroke-linejoin="round" stroke-width=".5" d="M29.33 26.68a10.61 10.61 0 01-10.68-10.54 10.5 10.5 0 01.34-2.65 10.56 10.56 0 1011.51 13.11 11.75 11.75 0 01-1.17.08z">
        <animateTransform attributeName="transform" dur="5s" repeatCount="indefinite" type="rotate" values="-5 19 20; 15 19 20; -5 19 20"/>
      </path>
    </g>
    <path fill="url(#rn-cloud)" stroke="#e6effc" stroke-miterlimit="10" stroke-width=".5" d="M46.5 31.5h-.32a10.49 10.49 0 00-19.11-8 7 7 0 00-10.57 6 7.21 7.21 0 00.1 1.14A7.5 7.5 0 0018 45.5a4.19 4.19 0 00.5 0v0h28a7 7 0 000-14z"/>
    <g>
      <path fill="none" stroke="#2885c7" stroke-linecap="round" stroke-miterlimit="10" stroke-width="2" d="M24.08 45.01l-.16.98m4.16-2.99l-.64 3.94m4.16-5.97l-1.12 6.9">
        <animateTransform attributeName="transform" dur=".7s" repeatCount="indefinite" type="translate" values="1 -5; -2 10"/>
        <animate attributeName="opacity" dur=".7s" repeatCount="indefinite" values="0; 1; 1; 0"/>
  ...
  "rainy": `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64">
    <defs>
      <linearGradient id="rain-cloud" x1="22.56" x2="39.2" y1="21.96" y2="50.8" gradientUnits="userSpaceOnUse">
        <stop offset="0" stop-color="#f3f7fe"/>
        <stop offset=".45" stop-color="#f3f7fe"/>
        <stop offset="1" stop-color="#deeafb"/>
      </linearGradient>
    </defs>
    <path fill="url(#rain-cloud)" stroke="#e6effc" stroke-miterlimit="10" stroke-width=".5" d="M46.5 31.5h-.32a10.49 10.49 0 00-19.11-8 7 7 0 00-10.57 6 7.21 7.21 0 00.1 1.14A7.5 7.5 0 0018 45.5a4.19 4.19 0 00.5 0v0h28a7 7 0 000-14z"/>
    <g>
      <path fill="none" stroke="#2885c7" stroke-linecap="round" stroke-miterlimit="10" stroke-width="2" d="M24.08 45.01l-.16.98m4.16-2.99l-.64 3.94m4.16-5.97l-1.12 6.9">
        <animateTransform attributeName="transform" dur=".7s" repeatCount="indefinite" type="translate" values="1 -5; -2 10"/>
        <animate attributeName="opacity" dur=".7s" repeatCount="indefinite" values="0; 1; 1; 0"/>
